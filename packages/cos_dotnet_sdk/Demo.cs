...
namespace QCloud.CosApi
{
    class CosDemo
    {
        ...
        const int APP_ID = 1001349;
        const string SECRET_ID = "AKIDFwXyJV0P5Zt1yibfstlV5Ys21oOor3rT";
        const string SECRET_KEY = "Zw6890iIgsrdDbliV6UgkdM0TjogLp7C";
        ...
        static void Main(string[] args)
        {
            try
            {
				...
				const string bucketName = "bucket4burning";
                const string localPath = @"D:\cos-dotnet-sdk\cos_dotnet_sdk\bin\IMG_2260.JPG";
                const string remotePath = "/sdktest/testest1.txt";
